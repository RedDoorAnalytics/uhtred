...
`RC' _uhtred__mm_root(	transmorphic x,      			/// bj: will be replaced by solution
...
`RC' survsim_epsilon_vec(real colvector y)
{
	res = J(rows(y),1,.)
